...
VIDEO_COMMENT_MAX_DURATION_SECONDS = env_int("VIDEO_COMMENT_MAX_DURATION_SECONDS", 20)
VIDEO_COMMENT_DURATION_TOLERANCE_SECONDS = float(os.environ.get("VIDEO_COMMENT_DURATION_TOLERANCE_SECONDS", "0.5"))
VIDEO_COMMENT_MAX_SIZE_MB = env_int("VIDEO_COMMENT_MAX_SIZE_MB", 50)
VIDEO_COMMENT_ALLOWED_EXTENSIONS = env_list("VIDEO_COMMENT_ALLOWED_EXTENSIONS", ".mp4,.mov,.webm")
VIDEO_COMMENT_ALLOWED_MIME_TYPES = env_list("VIDEO_COMMENT_ALLOWED_MIME_TYPES", "video/mp4,video/quicktime,video/webm")
