...
from .views import (
    ...
    FeedFollowingView, DiscoverView, PublicCommentsFeedView, ProfileFeedActivityView, UserProfileActivityView, UserProfileVideoReactionsView, PostListCreateView, PostDetailView, PostRatingView,
