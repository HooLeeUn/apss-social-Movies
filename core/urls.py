...
from .views import (
    ...
    FeedFollowingView, DiscoverView, PublicCommentsFeedView, ProfileFeedActivityView, FollowingVideoReactionsView, UserProfileActivityView, UserProfileVideoReactionsView, PostListCreateView, PostDetailView, PostRatingView,
    ...
    RegisterConfirmEmailView, RegisterUsernameAvailabilityView, ConfirmEmailChangeView,
    ...
    MovieListView, MovieSearchView, MovieDetailView, MovieCreditsView, MovieTrailerView, MovieWatchProvidersView, MovieDirectedCommentsListView, DirectedConversationMessagesView, MovieRatingView, MeTasteProfileView, FeedMoviesView, WeeklyRecommendationsView, MovieVideoCommentsListCreateView, VideoCommentDetailView, VideoCommentReactionView,
...
urlpatterns = [
    ...
    path("me/friend-requests/", MeFriendRequestsView.as_view(), name="me-friend-requests"),
    ...
    path("users/<str:username>/video-reactions/", UserProfileVideoReactionsView.as_view(), name="user-video-reactions"),
    ...
    path("profile-feed/following-video-reactions/", FollowingVideoReactionsView.as_view(), name="following-video-reactions"),
    ...
    path("video-comments/<int:pk>/reaction/", VideoCommentReactionView.as_view(), name="video-comment-reaction"),
