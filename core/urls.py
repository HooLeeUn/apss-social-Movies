...
from .views import (
    UserSearchView, UserProfileView, MeView, MePersonalDataView, FollowToggleView, UserFollowersListView, UserFollowingListView,
    ...
    ReceivedDirectedCommentsView, SentDirectedCommentsView, MePrivateMessagesView, MePrivateMessagesSummaryView,
...
urlpatterns = [
    ...
    path("me/messages/", MePrivateMessagesView.as_view(), name="me-private-messages"),
    path("me/messages/summary/", MePrivateMessagesSummaryView.as_view(), name="me-private-messages-summary"),
