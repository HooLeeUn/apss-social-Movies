...
from .views import (
    ...
    UserPostsListView, MovieCommentsListCreateView, MovieVideoCommentsListCreateView, VideoCommentDetailView, PostCommentsListCreateView, CommentDetailView, CommentReactionView, RegisterView,
