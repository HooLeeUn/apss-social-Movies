...
class Movie(models.Model):
    ...
    tmdb_lookup_status = models.CharField(max_length=20, blank=True, default="")
    tmdb_lookup_checked_at = models.DateTimeField(null=True, blank=True)
    tmdb_lookup_error = models.CharField(max_length=255, blank=True, default="")
    trailer_es_key = models.CharField(max_length=255, null=True, blank=True)
    trailer_en_key = models.CharField(max_length=255, null=True, blank=True)
    trailer_checked_at = models.DateTimeField(null=True, blank=True)
