        ...
        for movie in qs.iterator(chunk_size=500):
            ...
            try:
                ...
                if content_kind is None:
                    stats["skipped"] += 1
                    self.stdout.write(self.style.WARNING(f"Movie(id={movie.id}) type no soportado: {movie.type}"))
                    continue
                ...
                should_update_image = overwrite_image or not movie.image
                ...
                needs_en = overwrite_synopsis or not movie.synopsis
                needs_es = overwrite_synopsis or not movie.synopsis_es
